...
class ProductsTheme3 extends Component {
  ...
  SearchFilterFunction(text) {
    ...
    const newData = products.filter(function (item) {
      ...
      // alert(itemData.indexOf(textData) > -1+"  index")
  ...
  renderHeader = () => {
    ...
    return (
      <Header style={{ backgroundColor: this.state.themeColors.color }} >
        ...
        <Body style={{ flex: 1 }}>
          {/* New Products */}
          <Title style={{ fontSize: 22 }}> {this.state.time}</Title>
  ...
  renderFooter = () => {
    ...
    return (
      <View
        style={{ paddingVertical: 3, borderTopWidth: 1, borderColor: "#aaa", backgroundColor: '#fff' }}
      >
